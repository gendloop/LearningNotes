...
1. Set Visual Studio language to English:
    ...
    <img src="res/summary/1716960809613-8ceaef54-616a-4b9f-8c73-7016ceeb45d6.png" alt="" style="zoom: 50%;" />
...
3. Delete the keyboard mapping related to `Ctrl + [`
    ...
    * Delete `SolutionExplorer.OpenFilesFilter`
      ...
      <img src="res/summary/1716960946480-6461d7c4-6a9e-4465-a2e0-0bfa1fc0d27e.png" alt="" style="zoom: 50%;" />

    * Delete `SolutionExplorer.PendingChangesFilter`

      <img src="res/summary/1716961106945-0d7934f2-8e6f-4a3e-8312-6aff5c3fecc8.png" alt="" style="zoom: 50%;" />

    * Delete `SolutionExplorer.SyncWithActiveDocument`

      <img src="res/summary/1737006875129-5853bd70-c15c-4a5f-a379-9c75f0eae764.png" alt="" style="zoom: 50%;" />
