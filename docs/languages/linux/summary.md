...
| 操作 | 代码 | 示例输入 | 示例输出 |
| :-- | :-- | :-- | :-- |
| 去掉后缀 | `${var%.suffix}` | `file.txt` | `file` |
| 去掉所有后缀 | `${var%%.*}` | `file.tar.gz` | `file` |
| 去掉路径 | `${var##*/}` | `/home/file` | `file` |
| 去掉前缀 | `${var#prefix}` | `prefixfile` | `file` |
| 提取末尾数字 | `${var##*[!0-9]}` | `file123` | `123` |
| 去掉末尾数字 | `${var%%[0-9]*}` | `file123` | `123` |
